...
{
    public const string PLATAU_URL             = 'https://api.piste.gouv.fr/mtes/platau/v13/dau/';
    ...
    final public function __construct(array $config = [])
    {
        ...
        $retry_middleware = GuzzleRetryMiddleware::factory([
            ...
            'on_retry_callback' => static function (int $attemptNumber, float $delay, RequestInterface &$request, array &$_options, ?ResponseInterface $response) : void {
                $message = \sprintf(
