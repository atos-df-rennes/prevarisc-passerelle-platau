...
final class Console extends Application
{
    public function __construct(array $config = [])
    {
        ...
        $this->add(new Command\ExportPEC($container->get('service.prevarisc'), $container->get('service.platau.consultation'), $container->get('service.platau.piece'), $container->get('service.date_parser')));
        $this->add(new Command\ExportAvis($container->get('service.prevarisc'), $container->get('service.platau.consultation'), $container->get('service.platau.piece'), $container->get('service.platau.avis'), $container->get('service.date_parser')));
        ...
        $this->add(new Command\LectureNotifications($container->get('service.platau.notification'), $container->get('service.prevarisc'), $container->get('service.platau.consultation'), $container->get('service.platau.piece'), $container->get('service.platau.acteur'), $container->get('service.platau.nomenclature')));
        $this->add(new Command\RenvoiErreurs($container->get('service.prevarisc')));
    }
}
